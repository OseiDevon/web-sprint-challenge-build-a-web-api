...
router.get ('/:id', validateProjectId, (req, res) => {//eslint-disable-line
...
router.put ('/:id', validateProjectId, (req, res) => {//eslint-disable-line
    console.log(req.project)
    console.log("PUT endpoint connected")
})

router.delete ('/:id', validateProjectId, (req, res) => {//eslint-disable-line
    console.log(req.project)
    console.log("DELETE endpoint connected")
})

router.get ('/:id/actions', validateProjectId, (req, res) => {//eslint-disable-line
    console.log(req.project)
